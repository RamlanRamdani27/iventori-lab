        ...
        <div class="wrapper-page">
            <div class="panel panel-color panel-primary panel-pages">
                <div class="panel-heading bg-img"> 
                    ...
                    <h3 class="text-center m-t-10 text-white"><img  alt="" src="<?php echo base_url()?>/assets/images/Logo_iventori.png" width="100px" height="100px" ></h3>
                    <h3 class="text-center m-t-10 text-white"> Sign In to <strong>Iventori Lab</strong> </h3>

                </div> 


                <div class="panel-body">
                <form class="form-horizontal m-t-20" method="POST" action="<?php echo base_url()?>/Login/ceklogin">

                    <div class="form-group ">
                        <div class="col-xs-12">
                            <input class="form-control input-lg" type="email" required="" placeholder="Username" name="txtusername">
                        </div>
                    </div>

                    <div class="form-group">
                        <div class="col-xs-12">
                            <input class="form-control input-lg" type="password" required="" placeholder="Password" name="txtpassword">
                        </div>
                    </div>
