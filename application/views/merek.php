<div class="content-page">
    ...
    foreach ($merek as $row) {
        ...
        <th>
        <a class="btn btn-sm btn-primary" href="javascript:void(0)" title="Edit" onclick="edit_person('<?=$row->kodemerek;?>')"><i class="glyphicon glyphicon-pencil"></i> Edit</a>
                  <a class="btn btn-sm btn-danger" href="javascript:void(0)" title="Hapus" onclick="delete_person('<?=$row->kodemerek;?>')"><i class="glyphicon glyphicon-trash"></i> Delete</a>
...
function edit_person(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('merek/ajax_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            $('[name="id"]').val(data.id);
            $('[name="kodemerek"]').val(data.kodemerek);
            $('[name="namamerek"]').val(data.namamerek);
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="kodemerek" placeholder="kode barang" class="form-control" type="text" value="<?=$kode?>" readonly="">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="namamerek" placeholder="Nama Merek" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
